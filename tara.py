...
QUERIES = {
  ...
  "🤖 AI IDE Arayüz - Desktop": ["ai ide","coding agent ui","ai chat interface self hosted"],
  "🖥 Ai IDE Arayüz - Terminal": ["terminal coding agent","cli ai agent","terminal ai assistant"],
  "📊  Veri Görselleştirme": ["data visualization dashboard","chart library open source","veri görselleştirme"],
  "🧪 Chat - Team Talk": ["team chat self hosted","mattermost alternative","chat server open source","takım sohbet"],
  "🛍 Shopify-Etsy-Ebay-Amazon": ["shopify app open source","etsy marketplace tool","marketplace seller toolkit","pazar yeri aracı"],
  "🔒 2D - 3D Uygulama ve Paketler": ["2d design tool open source","3d editor open source","blender addon","parametric design","cad open source"],
  ...
  "📊 Proje Yönetimi & Çalışma Alan": ["project management self hosted","kanban open source","task management self hosted","proje yönetimi"],
  ...
  "🎬 Ses & Müzik & Video": ["media server","music server self hosted","video editor open source","medya sunucusu"],
